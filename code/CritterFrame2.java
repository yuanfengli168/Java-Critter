// Class CritterFrame2 provides the user interface for a simple simulation
// program.
...
public class CritterFrame2 extends JFrame {
    private CritterModel2 myModel;
    private CritterPanel2 myPicture;
    ...
    public CritterFrame2(int width, int height) {
        ...
        myModel = new CritterModel2(width, height);

        // set up critter picture panel
        myPicture = new CritterPanel2(myModel);
